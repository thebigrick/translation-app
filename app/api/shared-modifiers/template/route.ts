...
// GET /api/shared-modifiers/template - Download CSV template
export async function GET(request: NextRequest) {
  try {
    ...
    const headers = generateSharedModifierCSVHeaders(defaultLocale, targetLocale);
    ...
    return new NextResponse(csvContent, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="shared-modifiers-template.csv"',
      },
    });
  } catch (error: any) {
